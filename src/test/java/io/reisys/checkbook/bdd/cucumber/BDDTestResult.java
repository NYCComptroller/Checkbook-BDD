...
public class BDDTestResult implements Comparable<BDDTestResult> {
	...
	public String toString() {
		...
		if (!"SUCCESS".equals(testResult)) {
			resultDetails += failedStep + COMMA_DELIMITER  + StringEscapeUtils.escapeCsv(errorMessage) +LINE_SEPARATOR;
		} else {
	...
	@Override
	public int compareTo(BDDTestResult o) {

...
public class CheckbookBaseScenarioSteps extends ScenarioSteps {
  ...
  public void assertFieldContainsText(String fieldName, String fieldValue, String text) {
    ExecutionContext.appendToAssertionData(
        String.format("Validating '%s' field contains  UI count '%s' and DB count  '%s'", fieldName,
            fieldValue, text));
  ...
  public void assertFieldHasText(String fieldName, String fieldValue, String text) {
    ExecutionContext.appendToAssertionData(
        String.format("Validating '%s' field has  UI count '%s' and DB count  '%s' ", fieldName,
            fieldValue, text));
  ...
  public void assertListOfValues(String fieldName, List<String> fieldValues,
      List<String> valuesToValidate) {
    ExecutionContext.appendToAssertionData(
        String.format("Validating '%s' field has UI values '%s' and expcted values '%s'", fieldName,
            fieldValues, valuesToValidate));

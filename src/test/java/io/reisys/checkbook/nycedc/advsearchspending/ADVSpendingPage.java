...
public class ADVSpendingPage extends CheckbookBasePageObject {	
	...
	// public static final By Advanced_Search_Submit = By.linkText("Payroll_Submit");
	 public static final By Advanced_Search_Submit = By.xpath("//*[@id=\"edit-spending-submit--2\"]");
	...
	public void navigateToAdvancedSearchNYCEDCSpendingSubmit() {
		findElement(Advanced_Search_Submit).click();
	}
		

	
	public String getTotalCountForAdvancedSearchNYCEDCSpendingDetails() {
		return findElement(By.id("table_652_info")).getText();
	}
	public String getAdvancedSearchNYCEDCSpendingDetailsTitle() {
